...
local pokemons = {
{name = "Arbok", level = 1, extralevel = 114, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Golbat", level = 1, extralevel = 115, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Muk", level = 1, extralevel = 114, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Weezing", level = 1, extralevel = 114, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Nidoqueen", level = 1, extralevel = 117, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Nidoking", level = 1, extralevel = 118, sex = SEX_MALE, nick = "", ball = "normal"},
}
