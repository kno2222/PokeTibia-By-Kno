...
local pokemons = {
{name = "Vaporeon", level = 1, extralevel = 115, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Golduck", level = 1, extralevel = 117, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Blastoise", level = 1, extralevel = 118, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Starmie", level = 1, extralevel = 118, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Tentacruel", level = 1, extralevel = 117, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Gyarados", level = 1, extralevel = 120, sex = SEX_MALE, nick = "", ball = "normal"},
}
