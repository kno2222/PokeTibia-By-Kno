...
local pokemons = {
{name = "Victreebel", level = 1, extralevel = 110, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Vileplume", level = 1, extralevel = 110, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Exeggutor", level = 1, extralevel = 113, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Tangela", level = 1, extralevel = 115, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Venusaur", level = 1, extralevel = 119, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Scyther", level = 1, extralevel = 117, sex = SEX_MALE, nick = "", ball = "normal"},
