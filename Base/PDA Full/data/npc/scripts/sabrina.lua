...
local pokemons = {
{name = "Abra", level = 1, extralevel = 124, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Kadabra", level = 1, extralevel = 119, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Hypno", level = 1, extralevel = 117, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Mr. Mime", level = 1, extralevel = 117, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Porygon", level = 1, extralevel = 115, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Alakazam", level = 1, extralevel = 117, sex = SEX_MALE, nick = "", ball = "normal"},
}
