...
local msg = msg:lower()
        ...
        if msgcontains(msg, 'help') or msgcontains(msg, 'yes') and (not talkState[talkUser] or talkState[talkUser] == 0) then
           ...
           elseif getPlayerStorageValue(cid, Agatha.stoIni) ~= 50 or getPlayerLevel(cid) < 100 then
              ...
              selfSay("Then, is a simple task, i want you to kill {100 Musharnas}, you accept the task?", cid)
        ...
        elseif msgcontains(msg, 'yes') and talkState[talkUser] == 2 then
           ...
           selfSay("Ok then, go to the pyramids and find the entrance to the sanctuary of the Musharnas!", cid)
