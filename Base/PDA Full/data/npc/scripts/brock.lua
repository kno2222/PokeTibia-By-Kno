...
local pokemons = {
{name = "Geodude", level = 1, extralevel = 107, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Rhyhorn", level = 1, extralevel = 110, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Graveler", level = 1, extralevel = 110, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Onix", level = 1, extralevel = 115, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Golem", level = 1, extralevel = 118, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Rhydon", level = 1, extralevel = 117, sex = SEX_MALE, nick = "", ball = "normal"},
}
