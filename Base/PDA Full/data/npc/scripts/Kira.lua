...
local pokemons = {
{name = "Wigglytuff", optionalLevel = 1, extralevel = 110, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Pidgeot", optionalLevel = 1, extralevel = 115, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Lickitung", optionalLevel = 1, extralevel = 116, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Tauros", optionalLevel = 1, extralevel = 116, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Kangaskhan", optionalLevel = 1, extralevel = 120, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Snorlax", optionalLevel = 1, extralevel = 120, sex = SEX_MALE, nick = "", ball = "normal"},
}
...
local function doSummonGymPokemon(npc)
	...
	setWildPokemonLevel(summon, it.optionalLevel, getPokemonStatus(it.name, it.extralevel + it.optionalLevel), name, 1.5)
