...
local pokemons = {
{name = "Rapidash", level = 1, extralevel = 114, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Ninetales", level = 1, extralevel = 115, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Flareon", level = 1, extralevel = 115, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Arcanine", level = 1, extralevel = 118, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Charizard", level = 1, extralevel = 117, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Magmar", level = 1, extralevel = 119, sex = SEX_MALE, nick = "", ball = "normal"},
}
