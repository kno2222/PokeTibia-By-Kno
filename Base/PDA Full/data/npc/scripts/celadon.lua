...
function onCreatureSay(cid, type, msg)
	...
	if tonumber(msg) ~= nil and tonumber(msg) >= 1 and tonumber(msg) <= 500 and focus == cid then
		...
		if getPlayerStorageValue(cid, 23254) >= 10000000 then
			selfSay("It seems that you already have a lot of coins! You can't buy more coins if you already have more than 10000000.")
		return true
		end
	...
	if tonumber(msg) ~= nil and (tonumber(msg) < 1 or tonumber(msg) > 5000) and focus == cid then
		selfSay("I can sell only sell amounts between 1 and 5000 of coins at once!")
		conv = 2
	return true
	end
