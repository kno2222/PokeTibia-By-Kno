...
local pokemons = {
{name = "Pikachu", level = 1, extralevel = 115, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Galvantula", level = 1, extralevel = 117, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Raichu", level = 1, extralevel = 115, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Jolteon", level = 1, extralevel = 117, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Electabuzz", level = 1, extralevel = 117, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Ampharos", level = 1, extralevel = 119, sex = SEX_MALE, nick = "", ball = "normal"},
}
