...
return isCreature(cid) and getPlayerStorageValue(cid, 665450) >= 1  --alterado v2.9
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
function isOfficer(cid)
return isCreature(cid) and getPlayerStorageValue(cid, 665460) >= 1  --alterado v2.9
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
function randOutfit(cid, outs)   --alterado v2.9
...
if isCreature(npc) then
   doSetCreatureOutfit(npc, outfit, -1) --alterado v2.9
end
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
...
hunterWingeonTalks = {"You will die!", "The force of the air will help me!"}  --alterado v2.9  alterem aki
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--
wildRocket = {
...
[4] = {{name = "Girafarig", optionalLevel = 80, sex = SEX_FEMALE, nick = "", ball = "normal"},   --alterado v2.6
...
hunterWingeon = {
[1] = {{name = "Fearow", optionalLevel = 1000, sex = SEX_FEMALE, nick = "", ball = "normal"},     --alterado v2.9
