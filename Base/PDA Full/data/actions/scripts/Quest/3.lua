...
if item.uid == 12335 then
queststatus = getPlayerStorageValue(cid,12335)
if queststatus == -1 then  
setPlayerStorageValue(cid,12335,1)                          ------------------ FREEE
doPlayerAddItem(cid,6569,10)
doPlayerAddItem(cid,12618,50)
doPlayerAddPercentLevel(cid,500)
doTeleportThing(cid, Templo)
doPlayerSendTextMessage(cid, 19, "[FREE QUEST] Voce Fez a Quest! (Premio: [50] Boost Stone + [5] Level + [10] Rare Candy!)")
else
doTeleportThing(cid, Templo)
