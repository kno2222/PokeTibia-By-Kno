...
if getPlayerStorageValue(pid,6598754) == 1 and getPlayerGroupId(pid) <= 1 then
...
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE,"[Team vs Team] o Time Vermelho Esta Cheio!")
