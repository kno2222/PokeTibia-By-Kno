-- The Forgotten Server Config
	...
	increaseHunger = 0.001		-- a cada X segundos (xml do monstro) aumenta o hunger em "increaseHunger"
	...
	worldType = "pvp-enforced" ----- Nao altera é para funcionar o PVP-TEAM E PVP NORMAL(PARA FUNCIONAR O PVP TEAM O JOGADOR TEM QUE FEXAR A MAO QUE NEM FICAR PK NO TIBIA)
	protectionLevel = 1
	...
	maxPlayers = 120	
	motd = "Pokemon Online 2015"
	displayOnOrOffAtCharlist = false
	onePlayerOnlinePerAccount = false
	allowClones = true
	serverName = "Pokemon Online 2015"
	loginMessage = "Pokemon Online 2015"
	...
	experienceShareLevelDifference = 30 * 30
	extraPartyExperienceLimit = 5
